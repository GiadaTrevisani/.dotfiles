...
# or via wget:
#   zsh -c "$(wget -qO- https://raw.githubusercontent.com/GiadaTrevisani/.dotfiles/main/install.sh)"
# or via fetch:
#   zsh -c "$(fetch -o - https://raw.githubusercontent.com/GiadaTrevisani/.dotfiles/main/install.sh)"
#
# As an alternative, you can first download the install script and run it afterwards:
#   wget https://raw.githubusercontent.com/GiadaTrevisani/.dotfiles/main/install.sh
#   zsh install.sh
set -e
...
git clone https://github.com/GiadaTrevisani/.dotfiles.git ~/.dotfiles
if [ -f ~/.zshrc ]; then
    mv ~/.zshrc ~/.zshrc.bak
fi
if [ -f ~/.zshenv ]; then
